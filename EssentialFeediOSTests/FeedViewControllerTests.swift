...
final class FeedViewControllerTests: XCTestCase {
    ...
    func test_loadFeed_runsAutomaticallyOnlyOnFirstAppearance() {
        let (sut, loader) = makeSUT()
    ...
    func test_feedImageViewRetryButton_isVisibleOnInvalidImageData() {
        ...
        let view = sut.simulateViewVisible(at: 0)
    ...
    func test_loadImageDataCompletion_dispatchesFromBackgroundToMainThread() {
        ...
        sut.simulateAppearance()
        loader.completeFeedLoading(with: [makeImage()])
        _ = sut.simulateViewVisible(at: 0)
    ...
    func test_errorView_rendersErrorOnLoadError() {
        ...
        XCTAssertEqual(sut.errorMessage, localized(bundle: bundle, table: "Shared", "GENERIC_CONNECTION_ERROR"))
    ...
    private func makeSUT(file: StaticString = #file, line: UInt = #line) -> (sut: FeedViewController, loader: LoaderSpy) {
        ...
        let sut = FeedUIComposer.feedViewController(
            ...
            imageLoader: loader.loadImagePublisher(from:)
        )
